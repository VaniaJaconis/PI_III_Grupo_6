...
O digrama de casos de uso faz parte do modelo UML desse projeto, foi desenvolvido utilizando a plataforma Lucid e pode ser encontrado na pasta Diagramas, arquivo [Diagrama_de_casos_de_uso.md](https://github.com/VaniaJaconis/PI_III_Grupo_6/blob/main/Diagramas/Diagrama_de_casos_de_uso.md) deste repositório.

## Descrição dos Cenários
A descrição dos cenários foi baseada no diagrama de casos de uso e também faz parte do modelo UML entregue na primeira etapa do projeto. O conteúdo está diponível na pasta Diagramas, arquivo [Descrição_cenários.md](https://github.com/VaniaJaconis/PI_III_Grupo_6/blob/main/Diagramas/Descri%C3%A7%C3%A3o_cen%C3%A1rios.md) deste repositório.
